  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-14 sm:px-6 sm:py-20">
      <section className="grid gap-12 md:grid-cols-2 md:items-center md:gap-16">
        <div>
          <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/8 bg-white/4 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              to="/register"
              className="inline-flex items-center justify-center rounded-2xl bg-linear-to-r from-cyan-400 to-violet-400 px-6 py-3.5 text-sm font-semibold text-zinc-950 shadow-[0_0_32px_-6px_rgba(34,211,238,0.5)] transition hover:brightness-110"
            >
              Create your profile
            </Link>
            ...
            <Link
              to="/login"
              className="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/3 px-6 py-3.5 text-sm font-semibold text-zinc-100 transition hover:border-white/20 hover:bg-white/6"
            >
        ...
        <div className="relative">
          <div className="absolute -inset-4 rounded-4xl bg-linear-to-br from-cyan-400/10 via-transparent to-violet-400/10 blur-2xl" />
          <div className="relative rounded-[1.75rem] border border-white/8 bg-white/3 p-6 shadow-[0_24px_80px_-24px_rgba(0,0,0,0.65)] backdrop-blur-sm sm:p-8">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={row.k}
                  className="rounded-2xl border border-white/6 bg-zinc-950/50 px-4 py-3.5"
                >
      ...
      <section className="border-t border-white/6 py-16 sm:py-20">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div
              key={item.title}
              className="group rounded-2xl border border-white/7 bg-white/2 p-6 transition hover:border-white/15 hover:bg-white/4"
            >
              <span className="mb-4 inline-flex h-8 w-8 items-center justify-center rounded-xl bg-linear-to-br from-cyan-400/20 to-violet-400/20 text-xs font-bold text-cyan-200/90">
